            ...
            <div class='box-login'>
                <div class='fieldset-body' id='login_form'>
                    ...
                    <p class='field'>
                        ...
                        :value="EditProductTitle" @input="$emit('update:EditProductTitle', $event.target.value)"/>
                    ...
                    <p class='field'>
                        ...
                        <input class="input" type='text' id='user' name='user' title='Username' 
                        :value="EditProductPhotoUrl" @input="$emit('update:EditProductPhotoUrl', $event.target.value)"/>
                    ...
                    <p class='field'>
                        ...
                        <input class="input" type='text' id='user' name='user' title='Username' 
                        :value="EditProductPrice" @input="$emit('update:EditProductPrice', $event.target.value)"/>
                        <span id='valida' class='i i-close'></span>
                    </p>
                    <p class='field'>
                        ...
                        <input class="input" type='text' id='user' name='user' title='Username' 
                        :value="EditProductStoreName" @input="$emit('update:EditProductStoreName', $event.target.value)"/>
                        <span id='valida' class='i i-close'></span>
                    </p>
                    <p class='field'>
                        ...
                        <input class="input" type='text' id='user' name='user' title='Username' 
                        :value="EditProductStoreUrl" @input="$emit('update:EditProductStoreUrl', $event.target.value)"/>
                        <span id='valida' class='i i-close'></span>
                    </p>
                    <p class='field'>
                        ...
                        :value="EditProductDescription" @input="$emit('update:EditProductDescription', $event.target.value)"/>
                        <span id='valida' class='i i-close'></span>
                    </p>

                    <input type='submit' id='do_login' value='修改' title='Get Started' @click="$emit('isShowModelForEdit')" />
