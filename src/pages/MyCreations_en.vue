<template>
  ...
  <section class="info">
    ...
    <h1 class="veryCodeTitle">VERY CODE IN HERE &mdash; <a target="_blank">CheckJ's portfolios and ongoing projects</a></h1> 
  </section>
    ...
    <div class="card-grid-space">
      ...
      <a class="card" style="--bg-img: url('https://images1-focus-opensocial.googleusercontent.com/gadgets/proxy?container=focus&resize_w=1500&url=https://codetheweb.blog/assets/img/posts/basic-types-of-html-tags/cover.jpg')">
        <div>
          ...
          <div class="tags">
            <div class="tag">HTML</div><div class="tag">CSS</div>
            <div class="tag">Vuejs</div>
            <div class="tag">Java</div><div class="tag">MySQL</div>
            <div class="tag">ChatGPT</div>
          </div>
        </div>
      </a>
